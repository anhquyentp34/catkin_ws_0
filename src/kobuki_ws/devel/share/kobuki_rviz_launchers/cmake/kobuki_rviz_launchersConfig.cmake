...
if("TRUE" STREQUAL "TRUE")
  set(kobuki_rviz_launchers_SOURCE_PREFIX /home/hnam/kobuki_ws/src/kobuki_desktop/kobuki_rviz_launchers)
  set(kobuki_rviz_launchers_DEVEL_PREFIX /home/hnam/kobuki_ws/devel)
  ...
  set(kobuki_rviz_launchers_INSTALL_PREFIX /home/hnam/kobuki_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_rviz_launchers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hnam/kobuki_ws/src/kobuki_desktop/kobuki_rviz_launchers/${idir}'.  ${_report}")
    endif()
