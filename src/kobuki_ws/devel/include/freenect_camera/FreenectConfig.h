...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("image_mode", "int", 0, "Image output mode", "{'enum': [{'name': 'SXGA', 'type': 'int', 'value': 1, 'srcline': 8, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '1280x1024', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '640x480', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &FreenectConfig::image_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("depth_mode", "int", 0, "Depth output mode", "{'enum': [{'name': 'SXGA', 'type': 'int', 'value': 1, 'srcline': 8, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '1280x1024', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '640x480', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &FreenectConfig::depth_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(FreenectConfig::AbstractParamDescriptionConstPtr(new FreenectConfig::ParamDescription<int>("depth_mode", "int", 0, "Depth output mode", "{'enum': [{'name': 'SXGA', 'type': 'int', 'value': 1, 'srcline': 8, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '1280x1024', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg', 'description': '640x480', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &FreenectConfig::depth_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 8 "/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg"
      const int Freenect_SXGA = 1;
//#line 9 "/home/hnam/kobuki_ws/src/freenect_stack/freenect_camera/cfg/Freenect.cfg"
