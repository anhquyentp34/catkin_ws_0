...
echo_and_run cd "/home/hnam/kobuki_ws/src/kobuki_desktop/kobuki_qtestsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/hnam/kobuki_ws/src/kobuki_desktop/kobuki_qtestsuite/setup.py" \
     \
    build --build-base "/home/hnam/kobuki_ws/build/kobuki_desktop/kobuki_qtestsuite" \
    install \
    --root="${DESTDIR-/}" \
