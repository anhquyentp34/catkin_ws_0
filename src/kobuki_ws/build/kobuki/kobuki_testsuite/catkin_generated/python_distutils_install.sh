...
echo_and_run cd "/home/hnam/kobuki_ws/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/hnam/kobuki_ws/src/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/home/hnam/kobuki_ws/build/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
