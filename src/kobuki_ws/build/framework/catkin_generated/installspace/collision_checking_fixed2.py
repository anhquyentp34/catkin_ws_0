...
def teb_feedback_callback(feedback_msg):
    ...
    collision_predicted, predicted_object_path, collision_point = predict_collision(teb_traj_points, object_position, object_velocity, time_horizon=5.0, distance_threshold=1)
