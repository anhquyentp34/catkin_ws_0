...
def predict_collision(teb_traj_points, object_position, object_velocity, time_horizon, distance_threshold):
    ...
    for teb_point in teb_traj_points:
        ...
        if distance(teb_point.pose.position, predicted_object_position) < distance_threshold:
            ...
            # collision_point.x = (teb_point.pose.position.x + predicted_object_position.x)/2
            # collision_point.y = (teb_point.pose.position.y + predicted_object_position.y)/2
            # collision_point.z = teb_point.pose.position.z
            # return True, predicted_object_path, teb_point.pose.position
            return True, predicted_object_path, predicted_object_position
            # return True, predicted_object_path, collision_point
...
def teb_feedback_callback(feedback_msg):
    ...
    collision_predicted, predicted_object_path, collision_point = predict_collision(teb_traj_points, object_position, object_velocity, time_horizon=5.0, distance_threshold=1.5)
